...
public class PostsDatabaseHelper extends SQLiteOpenHelper {
    // Database Info
    private static final String DATABASE_NAME = "postsDatabase1";
    ...
    public void onCreate(SQLiteDatabase db) {
        String CREATE_POSTS_TABLE = "CREATE TABLE " + TABLE_POSTS +
                ...
                KEY_POST_TEXT + " TEXT," + KEY_CREATED_AT + " datetime default current_timestamp "  +
                ")";
    ...
    // Insert all post into the database
    public void addAllPosts(ArrayList<Tweet> tweetArrayList) {
        // Create and/or open the database for writing
        SQLiteDatabase db = getWritableDatabase();
        for (int i=0; i <tweetArrayList.size();i++) {
            Tweet post = tweetArrayList.get(i);

//        - See more at: http://java2novice.com/java-collections-and-util/arraylist/iterator/#sthash.GUbBCVfv.dpuf
...
//        - See more at: http://java2novice.com/java-collections-and-util/arraylist/iterator/#sthash.GUbBCVfv.dpuf
    ...
    public long addOrUpdateUser(User user) {
       ...
       //     values.put(KEY_USER_ID,user.getUid());
            ...
            values.put(KEY_USER_PROFILE_PICTURE_URL, user.getProfileIamgeURL());
            ...
            if (rows == 1) {
                ...
                String usersSelectQuery = String.format("SELECT %s FROM %s WHERE %s = ?",
                        KEY_USER_ID, TABLE_USERS, KEY_USER_NAME, KEY_SCREEN_NAME);
    ...
    public ArrayList<Tweet> getAllPosts() {
        ...
        String POSTS_SELECT_QUERY =
                String.format("SELECT * FROM %s LEFT OUTER JOIN %s ON %s.%s = %s.%s",
                        ...
                        TABLE_USERS, KEY_USER_ID + " ORDER BY " + KEY_POST_ID + " DESC");
        ...
        try {
            if (cursor.moveToFirst()) {
                do {
                    ...
                    newUser.setProfileIamgeURL(cursor.getString(cursor.getColumnIndex(KEY_USER_PROFILE_PICTURE_URL)));
    ...
    public ArrayList<Tweet> getspecficUser() {
        ArrayList<Tweet> posts = new ArrayList<>();
